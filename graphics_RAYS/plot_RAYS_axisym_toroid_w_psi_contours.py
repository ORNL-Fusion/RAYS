...
#
# DBB (7/28/2024)
# Adding plot of psi contours to the R-Z ray plot figure. The name for psi data netCDF
# file is 'normalized_psi.' + run_label + '.nc' where run_label comes from file
