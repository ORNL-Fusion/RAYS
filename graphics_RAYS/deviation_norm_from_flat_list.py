...
# 
def deviation_2d_array(in_list, len_sub_list, ref_list, offset):
    ...
    for sub_array in p_array:
        ...
        x = math.sqrt(np.sum(np.square(diff)))
        sub_list.append(x)
...
if __name__ == '__main__':
    ...
    ref_list = [1.,1.]
    offset = 2
    dev = deviation_2d_array(in_list, len_sub_list, ref_list, offset)
    print(dev)