...
"""
plot_profiles.py -> Plot deposition profiles from RAYS contained in a netCDF file.
N.B. These are the deposition profiles such as power or current, not plasma equilibrium
     such as density or temperature.

This code reads a CDF file and plots 1D profiles as produced by the RAYS code. The
netCDF file is generated by the post_process_m module.  Profile plots are written
to a .pdf file with the same name as the input .nc file with .nc replaced by .pdf
