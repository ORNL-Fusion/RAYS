...
! generic procedure: trapezoid_quad to calculate integral from a vector of y
...
!     
!     SUBROUTINE trapezoid_h_cum_real(h, y, integral, cum)
!     
!     IMPLICIT NONE
!     REAL, INTENT(IN) :: h, y(:)
...
!     
!     RETURN
!     END SUBROUTINE trapezoid_h_cum_real
