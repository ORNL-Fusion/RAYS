...
!_________________________________________________________________________________________
    ...
    pure function cross_product_S(A, B)
        IMPLICIT NONE
        REAL, INTENT(IN) :: A(3), B(3)
        REAL :: cross_product_S(3)
 ...
 !*********************************************************************************
    ...
    pure function triple_product_S(A, B, C)
        IMPLICIT NONE
        REAL, INTENT(IN) :: A(3), B(3), C(3)
        REAL :: triple_product_S
 ...
 !*********************************************************************************
    ...
    pure function triple_product_D(A, B, C)
        IMPLICIT NONE
 ...
 !*********************************************************************************
    ...
    pure function triple_vector_product_D(A, B, C)
        IMPLICIT NONE
        REAL(kind = rkind), INTENT(IN) :: A(3), B(3), C(3)
