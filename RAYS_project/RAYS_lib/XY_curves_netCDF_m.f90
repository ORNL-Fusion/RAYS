...
!     integer :: n_dims
    ...
    integer :: n_curves_id, grid_max_len_id
    integer :: n_curves, grid_max_len
    integer :: grid_name_max_len_id, curve_name_max_len_id
...
!   Declare netCDF variables
    ...
    write(*,*) " "
    write(*,*) 'write_XY_curves_netCDF, file = ', trim(out_filename)//'.nc'
